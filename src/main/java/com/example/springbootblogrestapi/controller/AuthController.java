...
import com.example.springbootblogrestapi.services.UserServices;
...
//         add check for exists in a DB
        if(userRepository.existsByUsername(signUpDto.getUsername())){
            return new ResponseEntity<>("Tài khoản đã tổn tại", HttpStatus.BAD_REQUEST);
        }
...
//        user.setRoles(Collections.singleton(roles));
    ...
    public ResponseEntity<?> DeleteUser(@PathVariable Long id){
        return userServices.DelUser(id);
    }
